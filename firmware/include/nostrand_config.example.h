...
// ISRG Root X1 validates the current Let's Encrypt chain used by Railway.
// If API_BASE_URL moves to a host with a different certificate authority,
// replace this trust anchor in your nostrand_config.h override.
constexpr char API_ROOT_CA[] = R"CERT(
-----BEGIN CERTIFICATE-----
